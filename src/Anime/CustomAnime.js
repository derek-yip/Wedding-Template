...
export const Opening_Anime=()=>{
  ...
  OpeningAnime.fromTo(FirstAnime,{xPercent:-100},{xPercent:0,duration:1})
  .fromTo(SecondAnime,{yPercent:100,duration:1},{yPercent:0,duration:1})
  .fromTo(bookmark_wrapper,{yPercent:-100,duration:1},{yPercent:0,duration:1})
  .to(h1,{y:-(h1.offsetHeight - window.innerHeight),duration:5,ease:'sine.inOut'})
